...
export default function Dashboard() {
  ...
  return (
   <div className="flex h-screen bg-gray-100">
      <aside className={`bg-gray-800 text-white w-64 space-y-6 py-7 px-2 absolute inset-y-0 left-0 transform ${sidebarOpen ? 'translate-x-0' : '-translate-x-0'}  md:relative md:translate-x-0 transition duration-200 ease-in-out`}>
        <nav>
